...
export default function ParagraphDisplay({ reference, onBackToSearch }: ParagraphDisplayProps) {
    ...
    <div className="space-y-6">
      ...
      {data && !isLoading && !error && (
        <div className="flex items-center justify-center space-x-4 text-sm text-muted-foreground">
          ...
          <Button variant="link" size="sm" onClick={onBackToSearch} className="p-0 h-auto">
            Go back to search
          </Button>
        </div>
      )}
